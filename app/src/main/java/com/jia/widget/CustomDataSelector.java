...
public class CustomDataSelector {
    ...
    public CustomDataSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.data_selector);
