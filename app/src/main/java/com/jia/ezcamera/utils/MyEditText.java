...
/**
 * 带删除按钮的edittext
 * Created by ls on 15/3/16.
 */
public class MyEditText extends android.support.v7.widget.AppCompatEditText {
    private static final String TAG = MyEditText.class.getCanonicalName();
    ...
    private void init() {
        /**获取图片资源*/
        imgEnable = mContext.getResources().getDrawable(R.drawable.png_close_circle);
//        setDrawable();
...
//                Log.i(TAG, "1-----onFocusChange     hasFocus=" + hasFocus + "     v.id=" + v.getId());
                if (hasFocus) {
                    setDrawable();
                } else {
