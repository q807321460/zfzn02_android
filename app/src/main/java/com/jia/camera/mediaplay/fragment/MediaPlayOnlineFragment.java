...
public class MediaPlayOnlineFragment extends MediaPlayFragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			mLiveReverse = (ImageView) mView.findViewById(R.id.live_reverse);
			...
			mLiveReverse.setOnClickListener(this);
...
//		}
	...
	public boolean startRecord() {
		...
		String path = MediaPlayHelper.getCaptureAndVideoPath(MediaPlayHelper.DHFilesType.DHVideo, channelName);
		// 开始录制 1
	...
	public void onClick(View view) {
		...
		case R.id.live_reverse:
			...
			play(R.string.video_monitor_reverse);
			Business.getInstance().modifyFrameReverseStatus(channelInfo.getDeviceCode(),
					String.valueOf(channelInfo.getIndex()),direction,new Handler(){
						@Override
						public void handleMessage(Message msg) {
