...
//	switch (v.getId()) {
//	case R.id.replaylayout:
//		replay();
//		break;
//	case R.id.txt_menu_play_pause:
//		if (!isPlaying) {
//			play(-1);
//		} else {
//			if (isPause) {
...
///**
// * @see java.lang.Runnable#run() 描述：显示流量和码率
// */
//@Override
//public void run() {
//	if (isAdded()) {			
...
//			txt_flow_rate_white.setText(getString(R.string.video_flow_count).concat(d.format(mTotalFlow / 1024.0f / 1024.0f)).concat(getString(R.string.video_flow_unit_M)).concat(getString(R.string.video_flow_space_3)).concat(getString(R.string.video_flow_speed)).concat(d.format((mTotalFlow - beforeTotle) / 1024.0f / 8.0f)).concat(getString(R.string.video_flow_unit_K_By_S)));
//			beforeTotle = mTotalFlow;
//
//		} else if (getActivity().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
//			txt_flow_rate_green.setText(getString(R.string.video_flow_count).concat(d.format(mTotalFlow / 1024.0f / 1024.0f)).concat(getString(R.string.video_flow_unit_M)).concat(getString(R.string.video_flow_space_3)).concat(getString(R.string.video_flow_speed)).concat(d.format((mTotalFlow - beforeTotle) / 1024.0f / 8.0f)).concat(getString(R.string.video_flow_unit_K_By_S)));
//			beforeTotle = mTotalFlow;
//		}
//		mHander.removeCallbacks(this);
//		mHander.postDelayed(this, 1 * 1000);
//	}
//}
