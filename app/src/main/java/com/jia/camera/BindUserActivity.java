...
import com.jia.znjj2.LoginActivity;
		...
		Business.getInstance().checkUserSms(mPhoneNumber, smsCode, new Handler(){
			...
			public void handleMessage(Message msg) {
				if(0 == msg.what)
				{
					...
					LoginActivity.userlogin(mPhoneNumber);
//					ContentValues contentValues = new ContentValues();
//					contentValues.put("le_sign",1);
//					mDC.mAccountData.updateAccount(contentValues);
//					new Thread(){
//						@Override
//						public void run() {
//							mDC.mWS.signLeCheng(mDC.sAccountCode);
//						}
//					}.start();
					finish();
				}
